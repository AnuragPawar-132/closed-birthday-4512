    ...
    <div>
      <div className={close ? "side-bar" : "side-bar2"}>
        ...
        <div className="nav-data">
          ...
          <br />
          <a
            href="https://himalayausa.com/pages/store-locator"
            className="LINK"
            target={"_blank"}
            onClick={() => setClose(false)}
          >
        ...
        <div className="account-data">
          ...
          <p onClick={() => (navigate("/Register"), setClose(false))}>
            Register
          </p>
          <p onClick={() => (navigate("/address"), setClose(false))}>
            Checkout
          </p>
        </div>
      </div>
      <div className={toggle ? "search-div" : "search-box"}>
        ...
        <div className="search_button">
          ...
          <img
            ...
            alt=""
            className="searchbtn"
            onClick={() => (navigate("/Shop"), setToggle(false))}
          />
        </div>
      </div>
      ...
      <nav className="wrapper">
        <div className="hum">
          ...
          />
          <img
            src="https://leap.himalayawellness.com/IOD/Content/images/login/header_logo.png"
            alt=""
            className="himalaya"
            onClick={() => Navigate("/")}
          />
          ...
          <div>
            ...
            <div className={visible ? "mega-box" : "megabox1"}>
              <div className="data">
                <div className="content">
                  <div className="row">
                    ...
                    <div className="mega-links">
                      <div>
                        <NavLink to="/HerbalSupplements" className="Link">
                          Single Herb Suppliments
                        </NavLink>
                      </div>
                      <div>
                        <Link to="/HerbalSupplements" className="Link">
                          Multi-Ingredient Suppliments
                        </Link>
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    ...
                    <div className="mega-links">
                      <div>
                        <Link to="/OralCare" className="Link">
                          Adult Toothpaste
                        </Link>
                      </div>
                      <div>
                  ...
                  <div className="row">
                    ...
                    <div className="mega-links">
                      <div>
                        <Link to="/PersonalCare" className="Link">
                          Face Care
                        </Link>
                      </div>
                      <div>
                ...
                <div className="content">
                  <div className="row">
                    ...
                    <div className="mega-links">
                      <div>
                        <Link to="/HealthInterests" className="Link">
                          Blood Sugar
                        </Link>
                      </div>
                      <div>
              ...
              <div>
                ...
                <p className="p">
                  Find Out Why everyone loves best selling Organic Ashwagandha
                </p>
              </div>
            </div>
            <div></div>
        ...
        <div className="rightside-icons">
          <div className="icons">
            <img
              src="https://www.linkpicture.com/q/search_9.png"
              alt=""
          ...
          <div className="hover_drop-down">
            <div className="icons">
              <img
                src="https://www.linkpicture.com/q/userlogo.png"
                alt=""
                className="icon-img"
              />
            </div>
            <div className="mini_drop-box">
              <div className="grid">
                <Link className="link-l" to={"/SignIn"}>
                  Sign In
                </Link>
                <Link className="link-l" to={"/Login"}>
                  Register
                </Link>
                <Link className="link-l" to={"/Checkout"}>
                  Checkout
                </Link>
              </div>
            </div>
          ...
          <Link to="/Cart" className="icons">
            <img
              src="https://www.linkpicture.com/q/shopping-bag.png"
              alt=""
              className="icon-img"
            />
          </Link>
